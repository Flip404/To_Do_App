...
class ToDoListNotDone extends StatefulWidget {
  const ToDoListNotDone({ Key? key }) : super(key: key);

  @override
  State<ToDoListNotDone> createState() => _ToDoListNotDoneState();
}

class _ToDoListNotDoneState extends State<ToDoListNotDone> {
  @override
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ToDo>>(
            stream: featuresProvider.listTodoNotDone(user.uid),
